...
export const commands: Command[] = [{
	...
	bindKey: bindKey(void 0, "Ctrl-Command-Option-0"),
	...
	bindKey: bindKey(void 0, "Option-PageDown"),
	...
	name: "pageup",
	description: "Page up",
	bindKey: bindKey(void 0, "Option-PageUp"),
...
// commands disabled in readOnly mode
{
	...
	bindKey: bindKey("Ctrl-Shift-Backspace"),
	exec: function(editor) {
	...
	bindKey: bindKey("Ctrl-Shift-Delete"),
	exec: function(editor) {
		var range = editor.selection.getRange();
...
for (var i = 1; i < 9; i++) {
	commands.push({
		...
		level: i,
		exec: function(this: Command, editor: Editor) { editor.session.foldToLevel(this.level!); },
		scrollIntoView: "center",
		readOnly: true
	});
}
