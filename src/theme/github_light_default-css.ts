...
".ace-github-light-default .ace_marker-layer .ace_selection": {
	backgroundColor: "rgba(3, 102, 214, 0.14)",
},
...
".ace-github-light-default .ace_marker-layer .ace_bracket": {
	margin: [-1, 0, 0, -1],
	border: "1 rgba(52, 208, 88, 0)",
	backgroundColor: "rgba(52, 208, 88, 0.25)",
},
