import type { VScrollBar } from "src/scrollbar";
...
export class ScrollDiffDecorator extends Decorator {
	 ...
	 */
	constructor(scrollbarV: VScrollBar, renderer: VirtualRenderer, forInlineDiff?: boolean) {
	...
	$setDiffDecorators(ctx: any, colors: any) {
